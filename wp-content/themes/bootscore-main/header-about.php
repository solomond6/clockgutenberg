  ...
  <div id="page" class="site">
    ...
    <header id="masthead" class="site-header">
      ...
      <div class="">
        ...
        <nav id="nav-main" class="navbar navbar-expand-lg navbar-light cocktale-header">
        ...
        <div class="container-fluid p-0" style="z-index: 1000;">
          <video controls="controls" preload="metadata" class="header-logo logo md" style="width: 100%; height: 2vvh;">
            <source src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/media/Cocktales-With-LA-My-Story.mp4#t=2.5" type="video/mp4">
          </video>
        </div>
        <div class="container">
          <div class="row">
