...
function bootscore_scripts() {
  ...
  if (file_exists(get_template_directory() . '/css/lib/bootstrap.css')) {
    $modificated_bootscoreCss = date('YmdHi', filemtime(get_template_directory() . '/css/lib/bootstrap.css'));
  } else {
  ...
  wp_enqueue_style('bootstrap', get_template_directory_uri() . '/css/lib/bootstrap.css', array(), $modificated_bootscoreCss);
  ...
  wp_enqueue_style('dynamic', get_template_directory_uri() . '/css/lib/dynamic.css', array(), $modificated_bootscoreCss);
