    ...
    <header id="masthead" class="site-header">
      ...
      <div class="cocktale-header">
        ...
        <!-- <div class="container-fluid p-0" style="z-index: 1000;">
          <img src="<?php //echo esc_url(get_stylesheet_directory_uri()); ?>/img/Splash_page_image.jpeg" class="contact-img">
        </div> -->
        <div class="contactbg">
          <div class="container">
            <div class="row pt-5">
              <div class="col-md-12 leadingText">
                <div class="mb-5">
                  <div class="mt-5 pt-0">
                    <h1 class="fs-1 text-white text-end" >
                    <!-- <img src="<?php //echo esc_url(get_stylesheet_directory_uri()); ?>/img/lade.png" class="lade-logo" alt="logo"> -->
                      <span>THIS IS</span><br/>
                      <span>L.A. WADE</span>
                    </h1>
                    <h4 class="fs-4 text-white text-end" >Author and Relation Wellness Expert</h4>
                    <div class="float-end"><?php echo do_shortcode('[DISPLAY_ULTIMATE_SOCIAL_ICONS]'); ?></span>
                  </div>
                </div>
              </div>
            </div>
