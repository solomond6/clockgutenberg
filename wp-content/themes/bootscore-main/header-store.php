  ...
  <div id="page" class="site">
    ...
    <header id="masthead" class="site-header">
      ...
      <div class="cocktale-header">
        ...
        <nav id="nav-main" class="navbar navbar-expand-lg navbar-light nahbar-store">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvas-navbar">
              ...
              <div class="offcanvas-body">
                ...
                wp_nav_menu(array(
                  ...
                  'items_wrap' => '<ul id="bootscore-navbar" class="navbar-nav nav justify-content-end ms-auto %2$s">%3$s</ul>',
                  'depth' => 2,
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 mt-5 mb-5 pt-5 leadingText text-center">
              <h1 class="fs-1 text-white pt-5" style="color: #6B1C85 !important; text-shadow: 1px 1px 1px rgb(0 0 0);" >
                <!-- <img src="<?php //echo esc_url(get_stylesheet_directory_uri()); ?>/img/lade.png" class="lade-logo" alt="logo"> -->
              <span>L.A. WADE <?php the_title() ?></span></h1>
              <h4 class="fs-4 text-white" style="color: #6B1C85 !important; text-shadow: 0px 0px 0px rgb(0 0 0);">Author and Relation Wellness Expert</h4>
              <?php //echo do_shortcode('[DISPLAY_ULTIMATE_SOCIAL_ICONS]'); ?>
            </div>
            <!-- <div class="col-md-6 text-center leadingImg">
              <img src="<?php //echo esc_url(get_stylesheet_directory_uri()); ?>/img/logo/Cocktales_logo.png" class="header-logo" alt="logo" class="logo md">
            </div> -->
